...
2. **Configure Google Maps API key** - see actual map markers
...
**Needs configuration:**
- `includes/mailer.php` - Add SMTP credentials
- `portal.php` - Replace Google API key placeholder
- `includes/totp.php` - Install TOTP library
...
4. Try the **"Add a single point manually"** form (new!)
5. You should see it added to the map (if you have a Maps API key)
